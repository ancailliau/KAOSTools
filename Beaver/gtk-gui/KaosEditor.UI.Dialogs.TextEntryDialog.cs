...
namespace Beaver.UI.Dialogs
{
	public partial class TextEntryDialog
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget Beaver.UI.Dialogs.TextEntryDialog
			this.Name = "Beaver.UI.Dialogs.TextEntryDialog";
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			this.DestroyWithParent = true;
			// Internal child Beaver.UI.Dialogs.TextEntryDialog.VBox
			...
			w4.Expand = false;
			w4.Fill = false;
			// Internal child Beaver.UI.Dialogs.TextEntryDialog.ActionArea
