...
namespace Editor.Dialogs
{
	public partial class AddAgent
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget Editor.Dialogs.AddAgent
			this.Name = "Editor.Dialogs.AddAgent";
			this.Title = global::Mono.Unix.Catalog.GetString ("Add new agent...");
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child Editor.Dialogs.AddAgent.VBox
			...
			w4.Expand = false;
			w4.Fill = false;
			// Internal child Editor.Dialogs.AddAgent.ActionArea
