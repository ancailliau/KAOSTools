...
namespace KaosEditor.UI.Dialogs
{
	public partial class AddAgent
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget KaosEditor.UI.Dialogs.AddAgent
			this.Name = "KaosEditor.UI.Dialogs.AddAgent";
			this.Title = global::Mono.Unix.Catalog.GetString ("Add new agent...");
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child KaosEditor.UI.Dialogs.AddAgent.VBox
			...
			w4.Expand = false;
			w4.Fill = false;
			// Internal child KaosEditor.UI.Dialogs.AddAgent.ActionArea
