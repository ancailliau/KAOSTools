...
namespace KaosEditor.UI.Dialogs
{
	public partial class AddGoal
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget KaosEditor.UI.Dialogs.AddGoal
			this.Name = "KaosEditor.UI.Dialogs.AddGoal";
			this.Title = global::Mono.Unix.Catalog.GetString ("Add new goal...");
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			this.Modal = true;
			// Internal child KaosEditor.UI.Dialogs.AddGoal.VBox
			...
			w5.Expand = false;
			w5.Fill = false;
			// Internal child KaosEditor.UI.Dialogs.AddGoal.ActionArea
