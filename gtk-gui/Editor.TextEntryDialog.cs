...
namespace Editor
{
	public partial class TextEntryDialog
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget Editor.TextEntryDialog
			this.Name = "Editor.TextEntryDialog";
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			this.DestroyWithParent = true;
			// Internal child Editor.TextEntryDialog.VBox
			...
			w4.Expand = false;
			w4.Fill = false;
			// Internal child Editor.TextEntryDialog.ActionArea
